...
@implementation NSObject (XDSwipeView)

- (CGSize)swipeViewItemSize:(__unused XDSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused XDSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused XDSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused XDSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused XDSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused XDSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused XDSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused XDSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused XDSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused XDSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end

@interface XDSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<XDSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<XDSwipeViewDelegate>)delegate
{
...
{
    [_itemViewPool enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
        NSSet *objects = obj;
        [objects enumerateObjectsUsingBlock:^(id obj, BOOL *stop) {
            UIView *storagedView = obj;
            [storagedView removeSwipeViewReseIdentifier];
        }];
    }];
...
{
    objc_setAssociatedObject(self, "SwipeViewResuKey", nil, OBJC_ASSOCIATION_ASSIGN);
}
@end
